...
public class OrdersController {
	...
	// Get Order by id
	@GetMapping("/{orderId}")
	public ResponseStructure<OrdersResponseDto> getOrder(@PathVariable Integer orderId) {
	...
	public ResponseStructure<String> deleteOrder(@PathVariable Integer orderId) {
	...
	@PutMapping("/{orderId}")
	public ResponseStructure<OrdersResponseDto> updateOrder(@PathVariable Integer orderId,
	...
	public ResponseStructure<List<OrdersResponseDto>> getOrdersByCustomer(@PathVariable Integer customerId) {
	...
	public ResponseStructure<List<OrdersResponseDto>> getOrdersByStore(@PathVariable Integer storeId) {
	...
	public ResponseStructure<OrdersResponseDto> updateStatus(@PathVariable Integer orderId,
