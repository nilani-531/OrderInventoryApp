...
public class ShipmentsService implements ShipmentsServiceInterface{
    ...
    public ShipmentsResponseDto getShipmentById(Integer shipmentId) {
    ...
    // Update shipment
    public ShipmentsResponseDto updateShipment(Integer shipmentId, ShipmentsRequestDto shipmentsRequestDto) {
    ...
    public ShipmentsResponseDto updateShipmentStatus(Integer shipmentId, ShipmentStatus shipmentStatus) {
    ...
    public List<ShipmentsResponseDto> getShipmentByCustomerId(Integer customerId) {
    ...
    public List<ShipmentsResponseDto> getShipmentByStoreId(Integer storeId) {
