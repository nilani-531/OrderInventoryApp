...
public class OrdersService implements OrdersServiceInterface {
    ...
    @Override
    public OrdersResponseDto updateOrderStatus(Integer orderId, OrderStatus newStatus) {
        Orders order = ordersRepository.findById(orderId)
                .orElseThrow(() -> new OrderNotFoundException("Order not found"));
    ...
    // Update Order store
    @Override
    public OrdersResponseDto updateOrderStore(Integer orderId, Integer storeId) {
        Orders order = ordersRepository.findById(orderId)
                .orElseThrow(() -> new OrderNotFoundException("Order not found"));
    ...
    @Override
    public OrdersResponseDto updateOrderCustomer(Integer orderId, Integer customerId) {
        Orders order = ordersRepository.findById(orderId)
                .orElseThrow(() -> new OrderNotFoundException("Order not found"));
    ...
    @Override
    public OrdersResponseDto updateOrderTms(Integer orderId, LocalDateTime orderTms) {
        Orders order = ordersRepository.findById(orderId)
                .orElseThrow(() -> new OrderNotFoundException("Order not found"));
    ...
    @Override
    public List<OrdersResponseDto> getOrdersByStoreId(Integer storeId) {
