...
import com.sprintProject.orderinventoryapplication.customexception.CustomerEmailAlreadyExistException;
import com.sprintProject.orderinventoryapplication.customexception.CustomerEmailNotFoundException;
...
public class CustomersService implements CustomersServiceInterface {
    ...
    // update the Customer
    public CustomersResponseDto updateCustomer(Integer customerId, CustomersRequestDto customersRequestDto) {
    ...
    // Delete the Customer
    public CustomersResponseDto deleteCustomer(Integer customerId) {
    ...
    public CustomersResponseDto  getCustomerByEmail(String customerEmail) {
    	if (customerEmail == null || !customerEmail.contains("@")) {
    	    throw new InvalidInputException(" Entered Invalid email: "+customerEmail);
    	}
   ...
   // Fetch orders from relationship
    ...
    public List<ShipmentsResponseDto> getCustomerShipments(Integer customerId) {
        Customers existingCustomer =customersRepository.findById(customerId) .orElseThrow(()->new CustomerIdNotFoundException("Customer not found with id:"+customerId)); 
