...
public class InventoryService implements InventoryServiceInterface {
	...
	@Override
	public InventoryResponseDto createInventory(Integer storeId, Integer productId, InventoryRequestDto inventoryRequestDto) {
	...
	@Override
	public InventoryResponseDto updateInventory(Integer inventoryId, Integer storeId, Integer productId,
	...
	public List<InventoryResponseDto> getInventoryByStore(Integer storeId) {
	...
	public List<InventoryResponseDto> getInventoryByProduct(Integer productId) {
